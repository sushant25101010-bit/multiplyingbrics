  ...
  return (
    <main className="min-h-[90vh] flex items-center justify-center p-4 sm:p-6 bg-slate-50/50 dark:bg-[#030712] transition-colors duration-300 relative overflow-hidden radial-glow">
      ...
      >
        ...
        {/* Tab Switched */}
        <div className="flex bg-slate-100 dark:bg-slate-950 p-1.5 rounded-2xl mb-8 border border-slate-200/40 dark:border-slate-800/30">
          <button 
            type="button"
            onClick={() => { setMode('login'); setError(null); setInfoMessage(null); }}
            className={`flex-1 py-3 text-sm font-extrabold rounded-xl transition-all duration-300 ${
              mode === 'login' 
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative flex items-center border border-slate-200 dark:border-slate-800 rounded-xl bg-slate-50 dark:bg-slate-950 focus-within:ring-4 focus-within:ring-amber-500/10 focus-within:border-amber-500/50 transition-all duration-200">
                    ...
                    <input
                      ...
                      className="w-full pl-11 pr-4 py-3.5 bg-transparent font-bold text-slate-900 dark:text-white outline-none text-sm placeholder:text-slate-350 dark:placeholder:text-slate-650"
                      required
                    />
                  </div>
                </div>
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="relative flex items-center border border-slate-200 dark:border-slate-800 rounded-xl bg-slate-50 dark:bg-slate-950 focus-within:ring-4 focus-within:ring-amber-500/10 focus-within:border-amber-500/50 transition-all duration-200">
                      ...
                      <input
                        ...
                        className="w-full pl-10 pr-4 py-3 bg-transparent font-bold text-slate-900 dark:text-white outline-none text-sm placeholder:text-slate-350 dark:placeholder:text-slate-650"
                        required
                      />
                    </div>
                  </div>
                  <div className="space-y-1.5">
                    <label htmlFor="lastName" className="text-[10px] font-bold uppercase tracking-widest text-slate-400 dark:text-slate-500">
                      Last Name
                    </label>
                    <div className="relative flex items-center border border-slate-200 dark:border-slate-800 rounded-xl bg-slate-50 dark:bg-slate-950 focus-within:ring-4 focus-within:ring-amber-500/10 focus-within:border-amber-500/50 transition-all duration-200">
                      <User size={14} className="absolute left-4 text-slate-400" />
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative flex items-center border border-slate-200 dark:border-slate-800 rounded-xl bg-slate-50 dark:bg-slate-950 focus-within:ring-4 focus-within:ring-amber-500/10 focus-within:border-amber-500/50 transition-all duration-200">
                    ...
                    <input
                      ...
                      className="w-full pl-[4.5rem] pr-4 py-3 bg-transparent font-bold text-slate-900 dark:text-white outline-none text-sm placeholder:text-slate-350 dark:placeholder:text-slate-650"
                      required
                    />
                  </div>
                </div>
